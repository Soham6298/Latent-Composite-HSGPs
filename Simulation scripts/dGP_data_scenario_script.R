...
derivgpmodel <- stan_model('dGP.stan')
ihsgpmodel <- stan_model('pcHSGP.stan')
igpmodel <- stan_model('pcGP.stan')
idhsgpmodel <- stan_model('pdHSGP.stan')
idgpmodel <- stan_model('pdGP.stan')
...
saveRDS(compare_table, 'dGP_data_scenario.rds')
