...
singlehsgpmodel <- stan_model('singlehsgp.stan')
...
compare_table <- rbind(compare_obshsgp, compare_derivhsgp, compare_idhsgp)
## comparison table edit
compare_table$data_id = paste0(compare_table$sim_id, '_', 
                               compare_table$d, '_',
                               compare_table$m)
saveRDS(compare_table, 'idhsgp_single_simout_n100.rds')
